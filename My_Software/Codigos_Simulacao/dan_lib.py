...
def warp(img):
   ...
   # dst = np.float32([[170, 220], [480, 220], [180, 0], [420, 0]]) #[[170, 220], [475, 220], [180, 0], [420, 0]]
    src = np.float32([[0, 100], [320, 100], [180, 0], [220, 0]])  # [[0, 220], [IMAGE_W, 220], [180, 0], [420, 0]]
    dst = np.float32([[90, 100], [250, 100], [180, 0], [220, 0]])  # [[170, 220], [475, 220], [180, 0], [420, 0]]
...
def fit_lines(img, plot=True):
    ...
    #print("left",leftx_base, rightx_base)
...
def curvature(left_fit, left_fit_null, right_fit, right_fit_null, lefty,righty, binary_warped, print_data=True):
    ...
    ym_per_pix = 0.5 / 90   # meters per pixel in y dimension
    xm_per_pix = 0.5 / 110 # meter per pixel in x dimension
